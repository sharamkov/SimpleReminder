...
public class AddReminderDialog extends DialogFragment implements DialogInterface.OnClickListener,
    ...
    public interface OnReminderAddedListener {
        ...
        void onReminderAdded(ReminderEntity newReminder, boolean saveToDatabase, boolean isNotify);
    ...
    public void onAttach(Activity activity) {
        ...
        onReminderAddedListener = (OnReminderAddedListener) activity;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialogBuilder.setTitle(R.string.new_reminder_dialog_title);
        ...
        CheckBox repeat = (CheckBox) dialogView.findViewById(R.id.repeat);
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        switch (which) {
            ...
            case DialogInterface.BUTTON_POSITIVE:
                ...
                reminderEntity.setKey(System.currentTimeMillis());
                ...
                onReminderAddedListener.onReminderAdded(reminderEntity, true, true);
    ...
    private void createTimePickerDialog() {
        ...
        TimePickerDialog timePickerDialog = TimePickerDialog.newInstance(
                ...
                }, current.get(Calendar.HOUR_OF_DAY), current.get(Calendar.MINUTE), DateFormat.is24HourFormat(getActivity())
        );
